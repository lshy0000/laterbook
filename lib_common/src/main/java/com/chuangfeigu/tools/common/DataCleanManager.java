...
public class DataCleanManager {
    ...
    public static String getTotalCacheSize(Context context) throws Exception {
        ...
        if (context != null &&Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
    ...
    private static boolean deleteDir(File dir) {
        ...
        if (dir.isDirectory()) {
            ...
            for (String tem:children) {
                boolean success = deleteDir(new File(dir, tem));
                if (!success) {
                    return false;
                }
            }
            ...
            try {
                ...
                for (File filed:fileList) {
                    ...
                    if (filed.isDirectory()) {
                        size = size + getFolderSize(filed);
                    } else {
                        size = size + filed.length();
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
